...
pub fn create_winit_window_attributes(
    ...
    #[cfg(target_os = "windows")]
    {
        ...
        // LOCAL PATCH (see vendor/README.md, tracking emilk/egui#8116): a window with a
        // DXGI-based (wgpu) swapchain needs this to get real per-pixel alpha compositing
        // from DWM; otherwise transparent pixels blend against an opaque white
        // redirection-bitmap surface instead of the desktop.
